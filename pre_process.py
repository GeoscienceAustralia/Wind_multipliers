...
def rasterize(input, output, input_topo, crop_topo):
    ...
    logger.info("Output TRANSFORM %f %f %f %f" % (geotransform_output[0],
                                                  geotransform_output[3],
                                                  geotransform_output[2],
                                                  geotransform_output[5]))
...
if __name__ == "__main__":
    ...
    pre_process(settlment_file, settlment_cat, landuse_file, landuse_cat,
                crop_mask_file, output_shapefile)
