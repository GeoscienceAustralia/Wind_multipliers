"""
 Title: test_nctools.py
 Author: Tina Yang, tina.yang@ga.gov.au
 CreationDate: 2014-06-02
 Description: Unit testing module for get_lat_lon and clip_array function
 in nctools.py
 Version: $Rev$
 $Id$
"""
...
class TestNctools(unittest.TestCase):
    ...
    def test_clip_array(self):
        ...
        extent_list = [[145.40, -13.40, 146.40, -14.40],
                       [145.20, -13.20, 146.20, -14.20],
                       [145.25, -13.25, 146.20, -14.20]]

        expected = np.array([[8,  9, 10],
                             [15, 16, 17],
                             [22, 23, 24]])
